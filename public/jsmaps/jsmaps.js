  ...
  $.fn.JSMaps = function(options) {
    ...
    var settings = $.extend({
      ...
      onStateOver: function() {
             ...
             document.getElementById(this.name).style.color="#512DA8";
             document.getElementById(this.name).style.fontWeight="bold";
      ...
      onStateOut: function() {
         ...
         document.getElementById(this.name).style.fontWeight="normal";
