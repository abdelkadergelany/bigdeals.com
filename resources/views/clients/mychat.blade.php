      ...
      <div class="inbox_people">
        <div class="headind_srch">
          ...
          <div class="inbox_chat">
            ...
            <button   class="grey" onclick="loadChat(this)" value="{{$conv->id}}" >
             
              <div class="chat_list">
                <div class="chat_people">
                  <div class="chat_img"> <img src="https://ptetutorials.com/images/user-profile.png" alt="sunil"> </div>
                  <div class="chat_ib">
                    <h5>{{returnNAme($conv->with)}} <span class="chat_date">{{$conv->updated_at->format('d M Y h:i')}}</span></h5>
                    <p style="color: black">{{returnLastMessage($conv->with)}}</p><br>
       ...
       <div class="mesgs">
        <div id="msg_history" class="msg_history">
          ...
          <span id="conv" data-with="{{$conversation->first()->with}}" class="d-block p-2 bg-primary text-white">  {{returnNAme($conversation->first()->with)}}</span><br><br>
...
<audio id="aud" style="visibility: hidden;" ><source src="{{asset('audio/messenger_web.mp3')}}" type="audio/mp3"></audio>
...
<script >
  ...
  function loadChat(t){
    ...
    for (i = 0; i < grey.length; i++) {
      grey[i].style.backgroundColor = "#e4e4e4";
    }
