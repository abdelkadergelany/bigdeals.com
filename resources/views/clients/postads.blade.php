...
<div class="alert alert-warning " role="alert">you can click <a href="{{route('profile')}}">here</a> to edit your personal informations so that next time when posting you will not have to reenter them again ! </div>
     ...
     <div class="form-group">
       ...
       data-dependent="modelName" name="brandName">
   ...
   <div class="form-group">
     ...
     data-live-search="true"   name="modelName" >
...
<div style="border: 2px solid blue; padding: 20px;">
  ...
  @if($inf->phone != null)
  Phone 1&nbsp;&nbsp;&nbsp;<input class=" " type="tel" placeholder="  9 digits " value="{{$inf->phone}}" pattern="[0-9]{9}" required  id="phone" name="phone1" > 
  @endif
  @if($inf->phone == null)
  Phone 1&nbsp;&nbsp;&nbsp;<input class=" " type="tel" placeholder="  9 digits " value="" pattern="[0-9]{9}" required  id="phone" name="phone1" > 
  @endif
  <span>
