   ...
   <div id="content">
    ...
    <div class="container-fluid">
      <div class="row">
       ...
       <button style="position: relative;margin-right: 15px; margin-left: 10%;" class="btn btn-success btn-sm" data-title="Add" data-toggle="modal" data-target="#add" ><i class="fas fa-plus-circle"></i>Post new Ads ({{$activatedCount +$inactivatedCount }})<div class="spinner-grow text-primary"></div></button><br><br>
       ...
       <a href="{{route('blockedAds')}}"><button style="position: relative;margin-right: 15px;" class="btn btn-danger btn-sm"   >Blocked Ads ({{$isBlockedCount}})<div class="spinner-grow text-primary"></div></button></a><br><br>
        ...
        <a href="{{route('vipAds')}}"><button style="position: relative;margin-right: 15px;" class="btn btn-warning btn-sm"   >VIP Ads ({{$vipValid}})<div class="spinner-grow text-primary"></div></button></a><br><br>
        ...
        <tbody>
          ...
          <tr>
            <td>{{"$ad->id"}}<br>
             ...
             @if($ad->buyNow=="1")
             <button  class="btn myadd-btn btn-success btn-sm" type="button"  >VIP Requested  
             </button> 
             @endif
             ...
             @endif
              @if($ad->buyNow=="2")
             <button  class="btn myadd-btn btn-danger btn-sm" type="button"  >WaitingCollection  
             </button> 
             @endif
           </td>
