            ...
            <div class="container">
                        ...
                        <table id="mytable" class="table table-bordred table-striped table-hover">
                           ...
                           <tbody>
                              ...
                              @endforeach
                                                 ...
                                                 {{ $models->appends(['action' => "displayModel"])->links() }}
               ...
               <div class="modal-dialog">
                  <div class="modal-content">
                    <form method="POST" action="{{ route('manageBrand')}}?action=addModel" enctype="multipart/form-data">
                        @csrf
                     <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
                        <h4 class="modal-title custom_align" id="Heading">Add New Model</h4>
                     </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                           <label for="first-disabled">Choose  the Brand: </label>
                            ...
                            data-hide-disabled="false" data-live-search="true"  name="brandName" required>

                               <option selected id="categoryNameUpdate" value="">Choose a Brand</option>
